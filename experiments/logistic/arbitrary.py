...
description = 'Logistic Regression with arbitrary coefficients.'
...
for w in cols:
    if len(w) >= 2:
        w_dict[w] = np.random.normal(loc=0, scale=1)
w_dict['good'] = +10  # paper case
model = Logistic(vectorizer, w_dict, lambda_0=0)
...
info = {'Description': description,
        'Model': MODEL, 'Coefficients': w_dict, 'Dataset': DATASET, 'Example': doc, 'N_runs': N_runs,
