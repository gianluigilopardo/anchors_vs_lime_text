...
description = 'Indicator function returning 1 if w="good" is present.'
...
MODEL = 'indicator'
w = 'good'
doc = "This place is not bad. Food is good!"
...
info = {'Description': description,
        'Model': MODEL, 'Words': w, 'Dataset': DATASET, 'Example': doc, 'N_runs': N_runs,
